...
public class ChannelSubscribeHandler extends ProtocolHandler{
	public static final Logger logger = LogManager.getLogger(ChannelSubscribeHandler.class);

    public static final CommunicationProtocol protocol = CommunicationProtocol.CHANNEL_SUBSCRIBE;
