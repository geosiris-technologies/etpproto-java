...
public class GrowingObjectHandler extends ProtocolHandler{
	public static final Logger logger = LogManager.getLogger(GrowingObjectHandler.class);

    public static final CommunicationProtocol protocol = CommunicationProtocol.GROWING_OBJECT;
